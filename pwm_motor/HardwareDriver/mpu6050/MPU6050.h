...
////void MPU6050_Calculate_Gyro_Offset_2(float *gx_offset,float *gy_offset,float *gz_offset, uint16_t steps);
...
//void MPU6050_initialize_2(void);
//void MPU6050_getMotion6_2(int16_t *ax, int16_t *ay, int16_t *az, int16_t *gx, int16_t *gy, int16_t *gz);
//void MPU6050_newValues_2(int16_t ax, int16_t ay, int16_t az, int16_t gx, int16_t gy, int16_t gz);
...
//void Prepare_ACC_Data(void);
//void Prepare_GYRO_Data(void);
#endif
