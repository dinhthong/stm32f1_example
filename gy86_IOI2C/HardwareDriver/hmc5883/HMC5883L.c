...
int16_t  HMC5883_FIFO_2[3][11]; //磁力计滤波
...
//	HMC5883_Buf_index_2 = (HMC5883_Buf_index_2 + 1) % HMC5883_Buf_Size;//循环
...
//	}
//	HMC5883_FIFO_2[0][10] = sum / 10;	//将平均值更新
...
{
	id[0] = IIC_ReadOneByte(HMC58X3_ADDR, HMC58X3_R_IDA);
	id[1] = IIC_ReadOneByte(HMC58X3_ADDR, HMC58X3_R_IDB);
	id[2] = IIC_ReadOneByte(HMC58X3_ADDR, HMC58X3_R_IDC);
}   // getID().
