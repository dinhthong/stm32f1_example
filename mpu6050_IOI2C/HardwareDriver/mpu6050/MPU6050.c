...
uint8_t buffer_2[14], Buf_index_2 = 0;	 //锟斤拷锟捷讹拷取锟斤拷锟斤拷锟斤拷
int16_t  MPU6050_FIFO_2[6][11];
...
int16_t MPU6050_Lastax_2, MPU6050_Lastay_2, MPU6050_Lastaz_2  //锟较达拷值
, MPU6050_Lastgx_2, MPU6050_Lastgy_2, MPU6050_Lastgz_2;
